 ...
 * @LastEditTime: 2021-03-09 20:53:08
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: /SimpleCode/C++/uthread/main.cpp
 */
#include "uthread.h"
#include <stdio.h>
...
void context_test()
{
    ...
    uc1.uc_link = &ucmain;  // 执行uc1之后会返回到ucmain
        
    makecontext(&uc1,(void (*)(void))func1,0);// 设置func1为uc1上下文

    swapcontext(&ucmain,&uc1);  // 上文保存为ucmain,到下文uc1执行
    puts("main");
}
