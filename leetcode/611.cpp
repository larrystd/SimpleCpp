...
public:
    ...
    */
    // backtrack_2
    int backtrack(vector<int>& nums, vector<int>& track, int index) {
        if (track.size() == 3) {
            if (track[2] < (track[0] + track[1])) 
                return 1;
            return 0;
