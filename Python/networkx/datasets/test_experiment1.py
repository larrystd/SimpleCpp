...
G = nx.read_edgelist('/home/larry/programs/Python/networkx/datasets/facebook_combined.txt', create_using=nx.Graph(), nodetype=int)
...
cluster_degree_x = range(len(cluster_degree))                            #生成x轴序列，从1到最大度
cluster_degree_y = [cluster_degree[i] for i in cluster_degree]  
