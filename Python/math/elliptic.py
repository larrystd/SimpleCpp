...
def encrypt(xG, yG, xK, yK, priv_key, a, p, n):
    ...
    """
    r = 4
    kGx, kGy = get_nG(xG, yG, r, a, p)  # kG
    kQx, kQy = get_nG(xK, yK, r, a, p)  # kQ
    ...
    cipher = (plain[0]+kQx, plain[1]+kQy)
    #c.append([kGx, kGy, cipher])
    print('(%d,%d),(%d,%d)' % (kGx, kGy, cipher[0],cipher[1]), end=' ')
    c = [(kGx, kGy), cipher]
    print(c)
    return c
